    ...
    def responses(
        ...
        if command == "doom":
            ...
            if existing_html:
                ...
                wad_url = f"{self.valves.GITHUB_REPO_URL}doom1.wad"
                ...
                # Step 1: Download and upload the doom1.wad file
                list_of_responses.append("```log\nDownloading WAD...        ")
                wad_id = self.download_and_create_file(
                    "doom1.wad", wad_url, "application/x-doom"
                )
                list_of_responses.append("DONE\n")
                ...
                list_of_responses.append("Downloading JavaScript... ")
                ...
                # Step 6: Provide the final HTML file ID to display in iframe
